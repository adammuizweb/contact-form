<?php
// /plugins/contact-form/public/form.php
// Shared renderer for the public contact form — used by the /contact/ page
// and by the [contact_form] shortcode. Returns self-contained HTML
...
function cf_render_form(PDO $pdo): string {
    ...
    $renderField = function (array $f): string {
    ...
    $fieldsHtml = implode("\n", array_map($renderField, $visibleFields));
...
(function(){
  ...
  form.addEventListener('submit', async function(e){
    ...
    var recaptchaPresent = !!form.querySelector('.g-recaptcha');
...
HTML;
    ...
    return str_replace(
        ['__CSRF_ESC__', '__FIELDS__', '__CSRF_JS__', '__RECAPTCHA_DIV__', '__RECAPTCHA_SCRIPT__'],
        [$csrfEsc, $fieldsHtml, $csrfJs, $recaptchaDiv, $recaptchaScript],
        $html
    );
}
